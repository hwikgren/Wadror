...
Membership.create user:u1, beer_club:club1, confirmed: true
Membership.create user:u2, beer_club:club1, confirmed: false
Membership.create user:u2, beer_club:club2, confirmed:true
